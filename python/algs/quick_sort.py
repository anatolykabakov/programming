"""
Сортировка Хоара или Быстрая -- алгоритм сортировки
последовательности чисел, наиболее эффективный.
Описание:
...
3. Пока длина входного массива не больше 1, Соединяем левый, серединный и
правый последовательности и возвращаем
