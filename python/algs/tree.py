"""
Дерево -- рекурсивная структура данных, состоящая из вершин.
Каждая вершина может иметь свое дерево.
...
4. если есть, то рекурсивно считаем сумму
вершин для детей начиная с п.1
"""
