...
CameraCalibService::CameraCalibService(double pitch0_deg, double yaw0_deg, double height_m, double fx, double fy,
                                       double cx, double cy, int history_len)
  : pose_calib_(pitch0_deg, yaw0_deg, height_m)
  , vp_calib_(history_len, pitch0_deg, yaw0_deg)
  , height_m_(height_m)
  , fx_(fx)
  , fy_(fy)
  , cx_(cx)
  , cy_(cy)
{
  last_.pitch_deg = pitch0_deg;
  last_.yaw_deg = yaw0_deg;
