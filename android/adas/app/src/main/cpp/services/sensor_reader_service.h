...
//   subscribe<ai::flow::android::ZMQMessage>("sensors/imu", [this](const auto& msg) {
//     // Process IMU data
//     if (msg.has_imu_data()) {
...
private:
  void processImuData(const ai::flow::android::ZMQMessage& msg);
  void processGpsLocation(const ai::flow::android::ZMQMessage& msg);
  void processGpsData(const ai::flow::android::ZMQMessage& msg);
  void processCameraBuffer(const ai::flow::android::ZMQMessage& msg);
