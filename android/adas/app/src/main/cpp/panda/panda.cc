...
{
  handle->control_write(0xdc, safety_model, safety_param);
}
...
void Panda::set_power_saving(bool power_saving) { handle->control_write(0xe7, power_saving, 0); }

void Panda::enable_deepsleep() { handle->control_write(0xfb, 0, 0); }

void Panda::send_heartbeat(bool engaged, bool engaged_mads) { handle->control_write(0xf3, engaged, engaged_mads); }
