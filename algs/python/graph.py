...
"""
Граф -- это структура, которая представлена множеством вершин и набором ребер(соединение между вершинами).

Очередь -- это структура данных, элементы добавляются в конец, достаются из начала FIFO
