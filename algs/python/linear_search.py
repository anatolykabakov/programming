...
"""
Линейный поиск -- алгоритм поиска элемента или индекса элемента в последовательности чисел.
Описание: последовательно сравниваем элементы последовательности с числом, если число найдено, 
