...
void shared_pass_by_ref(const std::shared_ptr<A>& ptr) { std::cout << ptr.use_count() << std::endl; }

void shared_pass_by_value(std::shared_ptr<A> ptr) { std::cout << ptr.use_count() << std::endl; }
