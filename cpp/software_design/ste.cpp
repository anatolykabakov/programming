...
SingleThreadExecutor::SingleThreadExecutor() { worker_ = std::thread(&SingleThreadExecutor::run, this); }
...
SingleThreadExecutor::~SingleThreadExecutor() { stop(); }

void SingleThreadExecutor::post(std::function<void()> task, std::chrono::milliseconds interval, bool periodic)
{
