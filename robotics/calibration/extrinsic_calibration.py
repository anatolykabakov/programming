...
if __name__ == "__main__":
    ...
    extrinsics = calibrate_extrinsics(dst, intrinsics, chessboard, chessboard_params, args.undistord)

    bev = generate_bev(dst, intrinsics, extrinsics, dsize = (args.rows * args.square_size, args.cols * args.square_size))
